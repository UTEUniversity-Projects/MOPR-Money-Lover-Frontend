...
import com.moneylover.databinding.ActivityViewReportByGroupTypeOptionBinding;
...
public class ViewReportByGroupTypeOptionActivity extends BaseActivity<ActivityViewReportByGroupTypeOptionBinding, ViewReportByGroupTypeOptionViewModel> {

    private ReportGroupType selectedGroupType;

    @Override
    public int getLayoutId() {
        return R.layout.activity_view_report_by_group_type_option;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        selectedGroupType = (ReportGroupType) getIntent().getSerializableExtra("selectedGroupType");
    ...
    public void setupTabLayout() {
        ...
        List<Class<? extends Fragment>> fragmentClasses = Arrays.asList(
                ViewReportByGroupTypeOptionListFragment.class,
                ViewReportByGroupTypeOptionListFragment.class
        );
        ...
        for (int i = 0; i < typeKeys.size(); i++) {
            ...
            args.putSerializable("selectedGroupType", selectedGroupType);
        ...
        int defaultTab = selectedGroupType != null && "INCOME".equalsIgnoreCase(selectedGroupType.getType()) ? 1 : 0;
        ...
        viewBinding.viewPager.setCurrentItem(defaultTab, false);
    }
