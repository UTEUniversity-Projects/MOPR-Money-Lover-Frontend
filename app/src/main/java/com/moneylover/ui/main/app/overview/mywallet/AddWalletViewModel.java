...
public class AddWalletViewModel extends BaseViewModel {
    ...
    public AddWalletViewModel(Repository repository, MVVMApplication application) {
    ...
    public void doAddWallet(MainCallback<ResponseWrapper<?>> callback, CreateWalletRequest request) {
        showLoading();
