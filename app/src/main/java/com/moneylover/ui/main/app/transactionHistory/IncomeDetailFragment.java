...
import com.moneylover.ui.main.app.transactionHistory.adapter.IncomeDetailBarchartAdapter;
import com.moneylover.ui.main.app.transactionHistory.adapter.IncomeDetailPieChartAdapter;
...
//    ------------------------------------------------------
    ...
    List<Income> incomes = Arrays.asList(
            new Income("Ăn uống", 5_000_000f, R.drawable.ic_drink, "01/04-06/04"),
            new Income("Di chuyển", 2_000_000f, R.drawable.ic_drink, "07/04-13/04"),
            new Income("Mua sắm", 50_000_000f, R.drawable.ic_drink, "14/04-20/04"),
            new Income("Hóa đơn", 3_000_000f, R.drawable.ic_drink, "21/04-27/04"),
            new Income("Nhậu", 1_000_000f, R.drawable.ic_drink, "28/04-04/05")
    );
