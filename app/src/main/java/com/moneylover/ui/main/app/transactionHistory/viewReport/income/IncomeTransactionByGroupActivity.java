...
import com.moneylover.databinding.ActivityIncomeTransactionByGroupBinding;
...
public class IncomeTransactionByGroupActivity extends BaseActivity<ActivityIncomeTransactionByGroupBinding, IncomeTransactionByGroupViewModel> {
    ...
    public int getLayoutId() {
        return R.layout.activity_income_transaction_by_group;
    }
    ...
    public void setupTabLayout() {
        ...
        for (int i = 0; i < months.size(); i++) {
            if (i % 3 == 0) {
                ...
                fragmentClasses.add(IncomeTransactionByGroupListFragment.class);
            }
        }
