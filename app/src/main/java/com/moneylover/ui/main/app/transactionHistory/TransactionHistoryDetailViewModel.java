...
public class TransactionHistoryDetailViewModel extends BaseViewModel {

    public TransactionHistoryDetailViewModel(Repository repository, MVVMApplication application) {
