...
import com.moneylover.databinding.ActivityExpenditureTransactionByGroupBinding;
...
public class ExpenditureTransactionByGroupActivity extends BaseActivity<ActivityExpenditureTransactionByGroupBinding, ExpenditureTransactionByGroupViewModel> {
    ...
    public int getLayoutId() {
        return R.layout.activity_expenditure_transaction_by_group;
    }
    ...
    public void setupTabLayout() {
        ...
        for (int i = 0; i < months.size(); i++) {
            if (i % 3 == 0) {
                ...
                fragmentClasses.add(ExpenditureTransactionByGroupListFragment.class);
            }
        }
