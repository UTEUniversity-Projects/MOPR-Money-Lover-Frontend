...
public class TransactionHistoryEditViewModel extends BaseViewModel {

    public TransactionHistoryEditViewModel(Repository repository, MVVMApplication application) {
