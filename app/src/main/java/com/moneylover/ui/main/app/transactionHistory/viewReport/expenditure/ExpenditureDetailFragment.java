...
import com.moneylover.ui.main.app.transactionHistory.viewReport.expenditure.adapter.ExpenditureDetailPieChartAdapter;
...
//    ------------------------------------------------------
    ...
    public void setupExpendituresWithPieChart() {
        ExpenditureDetailPieChartAdapter adapter = new ExpenditureDetailPieChartAdapter(getContext(), expenditures, new OnItemClickListener() {
            @Override
            public void onItemClick(int position) {
                NavigationUtils.navigateToActivity((AppCompatActivity) getActivity(), ExpenditureTransactionByGroupActivity.class, R.anim.slide_in_right, R.anim.slide_out_left);
            }
