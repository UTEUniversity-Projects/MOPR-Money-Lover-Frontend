...
public class ViewReportAdapter extends FragmentStateAdapter {
    ...
    public ViewReportAdapter(@NonNull FragmentActivity fragmentActivity, List<Class<? extends Fragment>> fragmentClasses) {
