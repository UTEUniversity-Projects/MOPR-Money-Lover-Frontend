...
import com.moneylover.databinding.ActivityIncomeBinding;
...
public class IncomeActivity extends BaseActivity<ActivityIncomeBinding, IncomeViewModel> {
    ...
    public void setupTabLayout() {
        ...
        for (int i = 0; i < months.size(); i++) {
            if (i % 3 == 0) {
                ...
                fragmentClasses.add(IncomeDetailFragment.class);
            }
        }
