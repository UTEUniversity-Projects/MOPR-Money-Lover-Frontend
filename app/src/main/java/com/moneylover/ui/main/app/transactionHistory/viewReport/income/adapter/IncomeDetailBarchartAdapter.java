...
import com.moneylover.databinding.ItemIncomeBarchartBinding;
...
public class IncomeDetailBarchartAdapter extends RecyclerView.Adapter<IncomeDetailBarchartAdapter.ViewHolder> {
    ...
    public IncomeDetailBarchartAdapter(Context context, List<Income> incomes, OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ItemIncomeBarchartBinding binding = ItemIncomeBarchartBinding.inflate(inflater, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private final ItemIncomeBarchartBinding binding;

        public ViewHolder(@NonNull ItemIncomeBarchartBinding binding) {
